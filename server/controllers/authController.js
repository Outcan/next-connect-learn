...
exports.validateSignup = (req, res, next) => {
  ...
  // Name is a non-null and is 4 to 10 characters
  req.checkBody("name", "Enter a name").notEmpty();
  req
    .checkBody("name", "Name must be between 4 and 10 characters")
    .isLength({ min: 4, max: 10 });

  // Email is non-null, valid and normalised
  req
    .checkBody("email", "Enter a vlaid email")
    .isEmail()
    .normalizeEmail();

  // Password is a non-null and is 4 to 10 characters
